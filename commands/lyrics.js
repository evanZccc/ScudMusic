...
async function lyrics(client, interaction) {
    try {
        ...
        try {
            ...
            lyricEmbed.setDescription(`❌ Nessuna lyrics trovata!`);
        ...
        const generateEmbed = (page) => {
            return new EmbedBuilder()
                ...
                .setFooter({ text: `Page ${page + 1} of ${lyricsArray.length} | Rischiesto da ${interaction.user.tag}` })
                .setTimestamp();
        };
        ...
        await interaction.editReply({ content: 'Si è verificato un errore durante il recupero delle lyrics.', ephemeral: true });
    }
}

module.exports = {
    name: "lyrics",
    description: "Mostra le lyrics della corrente canzone.",
    permissions: "0x0000000000000800",
    options: [{
        name: 'search',
        description: 'Query di ricerca per i testi',
